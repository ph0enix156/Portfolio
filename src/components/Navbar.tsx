        ...
        <div className="md:hidden border-b border-stone-200 dark:border-stone-800 bg-stone-50/98 dark:bg-stone-950/98 backdrop-blur-lg px-6 py-4 shadow-lg animate-in fade-in duration-150">
          ...
          <div className="pt-3 pb-1 flex flex-col gap-3">
            <button
              ...
              className="w-full inline-flex items-center justify-center gap-2 py-2.5 text-xs font-semibold border border-stone-200 dark:border-stone-700 rounded-md text-stone-800 dark:text-stone-100 bg-stone-100 dark:bg-stone-800 hover:bg-stone-200 dark:hover:bg-stone-700 cursor-pointer transition-colors"
            >
              <FileText className="w-3.5 h-3.5 text-stone-700 dark:text-stone-300" />
